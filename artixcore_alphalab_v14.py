...
class ArtixcoreAlphaLabPredictor(Predictor):
    """Artixcore AlphaLab v0.14: IC-balanced stable v0.8 ensemble."""
    ...
    _XGB = {
        ...
        "min_child_weight": 210, "reg_alpha": 0.03, "reg_lambda": 1.5,
    ...
    def train(self, features, target):
        ...
        try:
            ...
            self.xgb_model_ = xgb.train(
                self._XGB,
                xgb.DMatrix(matrix, label=yv, weight=recency),
    ...
    def predict(self, features):
        ...
        try:
            ...
            raw = self._FAST_WEIGHT * fast + self._STABLE_WEIGHT * stable + self._TREE_WEIGHT * tree
