...
class ArtixcoreAlphaLabPredictor(Predictor):
    """Artixcore AlphaLab v0.12: compact, syntax-safe v0.8 leaderboard core."""
    ...
    def train(self, features, target):
        ...
        try:
            ...
            dtrain = xgb.DMatrix(matrix, label=yv, weight=weights)
            self.xgb_model_ = xgb.train(self._XGB, dtrain, num_boost_round=self.n_xgb_rounds)
